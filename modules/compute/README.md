...
| <a name="input_allowed_vm_skus"></a> [allowed\_vm\_skus](#input\_allowed\_vm\_skus) | List of allowed VM SKUs for policy compliance | `list(string)` | <pre>[<br>  "Standard_D2s_v3",<br>  "Standard_K8S2_v1",<br>  "Standard_K8S_v1",<br>  "Standard_B2s",<br>  "Standard_B1s",<br>  "Standard_B1ms",<br>  "Standard_DS1_v2",<br>  "Standard_B4ms"<br>]</pre> | no |
